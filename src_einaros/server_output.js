stens@kamchatka ~/Dropbox/Documents/code/github/websockets-streaming-audio $ 
stens@kamchatka ~/Dropbox/Documents/code/github/websockets-streaming-audio $ 
stens@kamchatka ~/Dropbox/Documents/code/github/websockets-streaming-audio $ nn
npm start
...
npm info prestart websockets-streaming-audio@0.3.5
npm info start websockets-streaming-audio@0.3.5

> websockets-streaming-audio@0.3.5 start /home/stens/Dropbox/Documents/code/github/websockets-streaming-audio
> node src/app.js

websockets-streaming-audio 0.3.5
here is flavor_socket  einaros
here is __dirname  /home/stens/Dropbox/Documents/code/github/websockets-streaming-audio/src
here is parent_dir  /home/stens/Dropbox/Documents/code/github/websockets-streaming-audio/
here is working_dir  /home/stens/Dropbox/Documents/code/github/websockets-streaming-audio/src_einaros/
here is working_app  /home/stens/Dropbox/Documents/code/github/websockets-streaming-audio/src_einaros/local_app
app_obj  { connect_to_server: [Function] }
websockets-streaming-audio 0.3.5
shared-utils 0.1.3
shared_utils  { get_random_in_range_inclusive_float: [Function],
  ...
  convert_16_bit_signed_ints_into_32_bit_floats: [Function],
  toFixed: [Function],
...
AAAAAAAAAAAAAAAAAAAAA  route_msg  received_json  { mode: 'CatFoodNation',
  datatype: 'float',
...
__dirname  /home/stens/Dropbox/Documents/code/github/websockets-streaming-audio/src_einaros
requested_input_filename  /home/stens/Dropbox/Documents/code/github/websockets-streaming-audio/media/2500_hz_sine_2_seconds.wav
read_wav_file with input_filename  /home/stens/Dropbox/Documents/code/github/websockets-streaming-audio/media/2500_hz_sine_2_seconds.wav
...
thuthuthu IIIIIIIII inside read_file_into_buffer   filename  /home/stens/Dropbox/Documents/code/github/websockets-streaming-audio/media/2500_hz_sine_2_seconds.wav
...
backHome audio_obj 32 bit signed float   read_file_done  property -->filename<--   /home/stens/Dropbox/Documents/code/github/websockets-streaming-audio/media/2500_hz_sine_2_seconds.wav
...
curr_property  filename
curr_property  pcm_format
curr_property  audio_format
curr_property  num_channels
curr_property  sample_rate
curr_property  byte_rate
curr_property  bit_depth
curr_property  block_align
curr_property  bits_per_sample
curr_property  curr_state
curr_property  index_stream
curr_property  max_index
all_property_tags  { filename: '/home/stens/Dropbox/Documents/code/github/websockets-streaming-audio/media/2500_hz_sine_2_seconds.wav',
  pcm_format: 16,
  audio_format: 1,
  num_channels: 1,
  sample_rate: 44100,
  ...
  block_align: 2,
  bits_per_sample: 16,
  curr_state: 'populated',
  index_stream: 0,
  max_index: 88200 }
PREEEEE  0 out of 88200
POOOOOOST  16384 out of 88200
about to send binary temp_stream_chunk_buffer to client    curr_index  16384
...
stream_audio_to_client
INDEX  16384
PREEEEE  16384 out of 88200
POOOOOOST  32768 out of 88200
about to send binary temp_stream_chunk_buffer to client    curr_index  32768
Received message : {"mode":"CatFoodNation","datatype":"float","requested_action":"stream_audio_to_client","requested_source":null}
AAAAAAAAAAAAAAAAAAAAA  route_msg  received_json  { mode: 'CatFoodNation',
  datatype: 'float',
  requested_action: 'stream_audio_to_client',
...
stream_audio_to_client
INDEX  32768
PREEEEE  32768 out of 88200
POOOOOOST  49152 out of 88200
about to send binary temp_stream_chunk_buffer to client    curr_index  49152
Received message : {"mode":"CatFoodNation","datatype":"float","requested_action":"stream_audio_to_client","requested_source":null}
AAAAAAAAAAAAAAAAAAAAA  route_msg  received_json  { mode: 'CatFoodNation',
  datatype: 'float',
  requested_action: 'stream_audio_to_client',
...
stream_audio_to_client
INDEX  49152
PREEEEE  49152 out of 88200
POOOOOOST  65536 out of 88200
about to send binary temp_stream_chunk_buffer to client    curr_index  65536
Received message : {"mode":"CatFoodNation","datatype":"float","requested_action":"stream_audio_to_client","requested_source":null}
AAAAAAAAAAAAAAAAAAAAA  route_msg  received_json  { mode: 'CatFoodNation',
  datatype: 'float',
  requested_action: 'stream_audio_to_client',
...
stream_audio_to_client
INDEX  65536
PREEEEE  65536 out of 88200
POOOOOOST  81920 out of 88200
about to send binary temp_stream_chunk_buffer to client    curr_index  81920
Received message : {"mode":"CatFoodNation","datatype":"float","requested_action":"stream_audio_to_client","requested_source":null}
AAAAAAAAAAAAAAAAAAAAA  route_msg  received_json  { mode: 'CatFoodNation',
  datatype: 'float',
  requested_action: 'stream_audio_to_client',
...
stream_audio_to_client
INDEX  81920
PREEEEE  81920 out of 88200
POOOOOOST  88200 out of 88200
about to send binary temp_stream_chunk_buffer to client    curr_index  88200
