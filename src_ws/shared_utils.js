...
// bbb
    ...
    return { // to make visible to calling reference frame list function here comma delimited,
		...
		set_random_seed ,
		get_random_in_range_inclusive_float ,
		get_random_in_range_inclusive_int ,
		release_all_prop_from_object ,
		convert_32_bit_float_into_unsigned_16_bit_int_lossy ,
		convert_16_bit_unsigned_int_to_32_bit_float ,
		convert_16_bit_signed_int_to_32_bit_float ,
